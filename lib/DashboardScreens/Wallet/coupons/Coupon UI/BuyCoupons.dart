...
class _buyCouponsPageState extends State<buyCouponsPage> {
  ...
  static List<String> _TypeDropDown = <String>[
    "Buy 1 Get 1 Free", "Buy 2 Get 1 Free", "Buy 3 Get 2 Free", "Others"];
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
            Text("Type: ", style: commonTextStyles(),),
          SizedBox(width: 15.0,),
          Expanded(
            child: Card(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (_TypeDropDown) {
                      setState(() {
                        ...
                        selectedType == "Buy 1 Get 1 Free" ? isVisible = false : "";
                        selectedType == "Buy 2 Get 1 Free" ? isVisible = false : "";
                        selectedType == "Buy 3 Get 2 Free" ? isVisible = false : "";
        ...
        Container(
          ...
          child: Row(
            children: [
              Text("Total Price : ", style: commonTextStyles(),),
              Text("Rs 100", style: TextStyle(color: Color(0xffff09098A)),),
            ],
          ),
        ),
        SizedBox(height: 20,),
        ...
        Center(
          child: Container(
            ...
            child: ElevatedButton.icon(
                ...
                label: Text("Buy", style: commonBlueButtonTextStyles(),)),
          ),
        ),
      ],
    );
