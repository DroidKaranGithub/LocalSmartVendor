...
class _buyOneGetONePageState extends State<buyOneGetONePage> {
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Text("couponS REEDEMED".toUpperCase(),style:commonTextStyles() ,),
        ),
        // Container(
        ...
        Container(
          ...
          decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage("assets/image/cartoon-friends-celebrating-birthday-with-balloons-gifts_74855-6951 1.png"),fit: BoxFit.cover,
              )
          ),
            ...
            children: [
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 5,),
                    Text("fF12SDGFLTF", style: TextStyle(
                      color: Color(0xff09098A),
                      fontSize:   14,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(height: 10,),
                    Text("Coupon Used On ", style: TextStyle(
                      color: Color(0xff09098A),
                      fontSize:   16,
                      fontWeight: FontWeight.w600,
                    ),),
                    SizedBox(height: 5,),
                    Text("2-nov-21", style: TextStyle(
                      color: Color(0xff09098A),
                      fontSize:   14,
                      fontWeight: FontWeight.w400,
                    ),),
  ...
  backgoundImage(){
    return  Container(
        alignment: Alignment.bottomCenter,
        child: Image(image: AssetImage("assets/image/cartoon-friends-celebrating-birthday-with-balloons-gifts_74855-6951 1.png")));
  }
    ...
    return  Row(
      ...
      children: [
        ElevatedButton.icon(
            ...
            icon: Icon(Icons.arrow_back_sharp,color: Color(0xffffffff),),
            label: Text("Back",style: commonBlueButtonTextStyles(),)),
        ElevatedButton.icon(
            style: commonBlueButtons(),
            onPressed: (){
              Navigator.of(context).push(MaterialPageRoute(builder: (context)=> buyCouponsPage()));
            },
            icon: Icon(Icons.arrow_forward_ios,color: Color(0xffffffff),),
            label: Text("Next",style: commonBlueButtonTextStyles(),)),
      ],
    );
  }
}
